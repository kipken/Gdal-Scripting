...
def change_pixel_values(file_name, output_file_name, look_up_field, input_val, look_up_field_2=None):
    ...
    time_lapsed = (end-start)/60
    print("Processing time: {}".format(time_lapsed))
...
file_name = "./data/create_new_rat.tif"
...
change_pixel_values(file_name, output_file_name, "Expe", 10, )
